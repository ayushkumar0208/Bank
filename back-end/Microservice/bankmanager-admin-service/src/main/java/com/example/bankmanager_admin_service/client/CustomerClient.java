...
@FeignClient(name = "customer-transaction-loan-service"  ,contextId = "customerClient")
public interface CustomerClient {
    ...
    ResponseEntity<CustomerDTO> updateCustomer(@PathVariable String ssnId, @RequestBody CustomerDTO customer);

    @DeleteMapping("/api/customers/{ssnId}")
    ResponseEntity<String> deleteCustomer(@PathVariable String ssnId);
