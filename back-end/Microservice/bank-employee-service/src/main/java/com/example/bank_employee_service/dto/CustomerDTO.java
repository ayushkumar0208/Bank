...
public class CustomerDTO {
    ...
    // Full constructor
    public CustomerDTO(Long id, String ssnId, String firstName, String lastName, String email, String contactNumber,
                       LocalDate dob, String gender, String maritalStatus, String address,
                       String panCardNumber, String aadharCardNumber, String ifscCode,
                       double accountBalance, boolean isCustomerVerified,String password) {
        this.id = id;
        this.ssnId = ssnId;
 ...
 // Include in constructor, getter and setter
 ...
 public void setPassword(String password) {
    ...
    public boolean isCustomerVerified() { return isCustomerVerified; }

    public void setCustomerVerified(boolean customerVerified) { isCustomerVerified = customerVerified; }
}